  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <Menu>
          <Link
            to={`${oiConstant.url.brochure.base}${oiConstant.url.brochure.donwloadProduct}`}
          >
            <MenuItem>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <Menu>
          <Link
            to={`${oiConstant.url.brochure.base}${oiConstant.url.brochure.purchaseTicket}`}
          >
            <MenuItem>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        {user ? (
          <Menu>
            <Link to={`${oiConstant.url.service.base}`}>
              <MenuItem>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
